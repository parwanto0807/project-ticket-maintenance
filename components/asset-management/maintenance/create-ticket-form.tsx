...
const CreateTicketForm = ({ assetFind, employeeDataFind }: { assetFind: Asset[]; employeeDataFind: Employee[] }) => {
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="max-w-4xl mx-auto bg-white dark:bg-gray-900 p-2 rounded-xl shadow-lg space-y-6 max-h-full overflow-y-auto mb-16">
