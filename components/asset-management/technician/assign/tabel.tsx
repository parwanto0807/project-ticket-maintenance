...
export default function AssignTable({
    ...
    if (loading) {
        return <div className="py-20 text-center font-medium text-slate-500">Loading tickets...</div>;
    }

    if (!data || data.length === 0) {
        return <div className="py-20 text-center font-medium text-slate-500">No tickets found.</div>;
    }
                                        ...
                                        {item.completedDate && (
                                            <div>
                                                ...
                                                <p className="text-xs font-medium text-emerald-600">
                                                    {new Date(item.completedDate).toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric' })}
                                                </p>
                                            </div>
                                        )}
                                    </div>
