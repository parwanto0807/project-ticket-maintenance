          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-4 lg:mb-8">
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-9 h-9 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-lg sm:rounded-2xl flex items-center justify-center shadow-lg shadow-blue-500/30">
                  <Sparkles className="h-4 w-4 sm:h-6 sm:w-6 text-white" />
                </div>
                <div>
                  <h1 className="text-lg sm:text-2xl lg:text-3xl font-extrabold tracking-tight bg-gradient-to-br from-gray-900 to-gray-700 dark:from-white dark:to-gray-200 bg-clip-text text-transparent">
                    Dashboard
                  </h1>
                </div>
              </div>
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 lg:gap-6">
              ...
              <div className="flex-1">
                <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-[15px] sm:text-xl font-bold text-gray-800 dark:text-white mb-0.5">
                        Selamat datang, {user?.name || 'User'}!
                      </h2>
                      <p className="text-gray-500 dark:text-gray-400 flex items-center gap-1.5 text-[11px] sm:text-base font-medium">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-2 lg:flex gap-2 sm:gap-4">
                <div className="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-[14px] sm:rounded-2xl border border-gray-200/60 dark:border-gray-700/60 shadow-sm hover:shadow-md transition-all duration-200">
                  <div className="w-7 h-7 sm:w-10 sm:h-10 bg-blue-50 dark:bg-blue-900/30 rounded-lg sm:rounded-xl flex items-center justify-center">
                    <TrendingUp className="h-3.5 w-3.5 sm:h-5 sm:w-5 text-blue-600 dark:text-blue-400" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-[10px] sm:text-sm font-bold text-gray-500 dark:text-gray-400 truncate uppercase tracking-wider">Performa</p>
                    <p className="text-[13px] sm:text-lg font-black text-gray-900 dark:text-white truncate">Optimal</p>
                  </div>
                </div>

                <div className="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 sm:py-3 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-[14px] sm:rounded-2xl border border-gray-200/60 dark:border-gray-700/60 shadow-sm hover:shadow-md transition-all duration-200">
                  <div className="w-7 h-7 sm:w-10 sm:h-10 bg-green-50 dark:bg-green-900/30 rounded-lg sm:rounded-xl flex items-center justify-center">
                    <Shield className="h-3.5 w-3.5 sm:h-5 sm:w-5 text-green-600 dark:text-green-400" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-[10px] sm:text-sm font-bold text-gray-500 dark:text-gray-400 truncate uppercase tracking-wider">Keamanan</p>
                    <p className="text-[13px] sm:text-lg font-black text-gray-900 dark:text-white truncate">Terjamin</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="relative px-2 sm:px-6 lg:px-8 py-4 sm:py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="lg:hidden flex items-center gap-2 mb-4">
            ...
            <h2 className="text-[15px] font-extrabold text-gray-800 dark:text-white uppercase tracking-tight">
              Ringkasan
            </h2>
          </div>
          ...
          <section className="mb-6 sm:mb-12">
            <div className="relative">
              <div className="absolute -inset-1 sm:-inset-4 bg-gradient-to-r from-blue-500/5 to-indigo-500/5 blur-xl rounded-3xl" />
              <div className="relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-xl sm:rounded-2xl border border-white/50 dark:border-gray-700/50 shadow-lg sm:shadow-2xl shadow-blue-500/5 dark:shadow-black/20 p-1">
                <DashboardCards />
              </div>
            </div>
          </section>
          ...
          <section>
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4 sm:mb-8">
              <div className="flex items-center gap-2.5">
                <div className="w-7 h-7 sm:w-8 sm:h-8 bg-gradient-to-br from-orange-500 to-amber-500 rounded-lg flex items-center justify-center shadow-sm">
                  <Activity className="h-4 w-4 text-white" />
                </div>
                <div>
                  <h2 className="text-[15px] sm:text-xl font-extrabold text-gray-800 dark:text-white tracking-tight">
                    Analitik & Insight
                  </h2>
                  <p className="text-[10px] sm:text-sm text-gray-500 dark:text-gray-400 font-medium">
                    Metrik performa waktu nyata
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 text-sm">
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-gray-500 dark:text-gray-400 text-[10px] sm:text-sm font-bold uppercase tracking-wide">Tiket</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <div className="w-1.5 h-1.5 bg-green-500 rounded-full" />
                    <span className="text-gray-500 dark:text-gray-400 text-[10px] sm:text-sm font-bold uppercase tracking-wide">Pemeliharaan</span>
                  </div>
                </div>
